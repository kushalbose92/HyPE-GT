...
"""
    Graph Transformer with edge features for ogbg-molpcba dataset
...
class GraphTransformer(nn.Module):
    def __init__(self, net_params):
        ...
        self.embedding_h = AtomEncoder(emb_dim = GT_hidden_dim) #Remove some embedding dimensions to make room for concatenating LPE
