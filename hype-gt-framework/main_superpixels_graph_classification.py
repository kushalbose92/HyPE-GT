...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    # from utils import hyperbolicity
    # print(len(trainset), "  ", len(valset), "  ", len(testset))
    # totalset = trainset+valset+testset
    # print(len(totalset)) 
    # hyp_total = 0.0
    # for g in tqdm(totalset):
    #     g_nx = dgl.to_networkx(g[0])
    #     # print(type(g_nx))
    #     hyp = hyperbolicity.hyperbolicity_sample(g_nx, num_samples=g_nx.number_of_nodes()*100)
    #     # print(hyp)
    #     hyp_total += hyp
    # print("Hyperbolicity ", hyp_total/len(totalset))
