...
class MoleculeDataset(torch.utils.data.Dataset):
    ...
    def _add_rand_walk_positional_encodings(self, pos_enc_dim):
        ...
        # Graph positional encoding v/ Laplacian eigenvectors
        self.train.graph_lists = [rand_walk_positional_encoding(g, pos_enc_dim) for g in self.train.graph_lists]
        self.val.graph_lists = [rand_walk_positional_encoding(g, pos_enc_dim) for g in self.val.graph_lists]
        self.test.graph_lists = [rand_walk_positional_encoding(g, pos_enc_dim) for g in self.test.graph_lists]
